    ...
    <div className="min-h-screen flex flex-col bg-[#FDF8F5]">
      ...
      <main className="flex items-center justify-center flex-grow px-8 overflow-y-auto py-7">
        ...
        <div className="relative flex flex-col w-full mt-4 sm:flex-row sm:items-center sm:justify-center">
            {/* 제목 */}
            <h1 className="text-4xl font-bold text-center text-mainColor sm:text-left max-[430px]:text-xl">
              반려동물 매칭 정보
            </h1>

          </div>
          <div className="flex flex-wrap justify-center w-full gap-10 max-[816px]:gap-5 max-[700px]:gap-2">
            {petInfo.details.map((item, index) => (
                <div
                  key={index}
                  className="px-8 py-3 text-2xl text-white border rounded-2xl bg-mainColor max-[1010px]:text-lg max-[855px]:text-xs max-[655px]:px-3"
                >
                  <span
          ...
          <div className="h-[30vh] max-[400px]:w-[20vh] sm:h-[35vh] md:h-[40vh] lg:h-[40vh] xl:h-[40vh] 2xl:h-[40vh] w-[30vh] sm:w-[45vh] md:w-[55vh] lg:w-[60vh] xl:w-[65vh] 2xl:w-[65vh] bg-gray-200 flex items-center justify-center rounded-md overflow-hidden">
            {petInfo.petImage ? (
              <img
          ...
          <div className="flex items-center justify-center w-full gap-14">
            ...
            {petInfo.petId && !isLoading && (
              <button
                className="px-4 text-sm text-white bg-mainColor rounded-2xl sm:text-xl lg:text-2xl hover:underline"
