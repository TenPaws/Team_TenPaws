                ...
                .cors((cors) -> cors
                        .configurationSource(new CorsConfigurationSource() {
                            ...
                            public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                                ...
                                configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://3.38.196.10", "http://3.38.196.10:8080"));
                                //configuration.setAllowedOrigins(Collections.singletonList("http://localhost:3000"));
                                //configuration.setAllowedOrigins(Collections.singletonList("http://3.38.196.10:8080"));
